...
SECRET_KEY = 'django-insecure-=qjo-qa5+xbdt&zz)=%t+od9v*b4#!&hdlbi3wxbb$2pu8=b)p'
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_REFRESH_ALGORITHM': 'sli',
    'SLIDING_TOKEN_LIFETIME_GRACE_PERIOD_ALGORITHM': 'sli',
}
